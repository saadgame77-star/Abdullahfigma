      ...
      { 
        ...
        Component: () => (
          <div className="flex flex-col items-center justify-center min-h-[50vh] text-center px-4">
             <h1 className="font-serif text-6xl font-bold text-[var(--color-islamic-green)] mb-4">404</h1>
             <p className="text-xl text-gray-600 mb-8">عذراً، الصفحة التي تبحث عنها غير موجودة.</p>
             <a href="/" className="bg-[var(--color-islamic-gold)] text-white px-6 py-2 rounded-sm font-bold">العودة للرئيسية</a>
          </div>
        )
      },
    ],
